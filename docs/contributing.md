...
Contributions are welcome. `go-ruby-resque/resque` is built to a small set of
...
The library is in [`github.com/go-ruby-resque/resque`](https://github.com/go-ruby-resque/resque).
This documentation site is in [`github.com/go-ruby-resque/docs`](https://github.com/go-ruby-resque/docs).
