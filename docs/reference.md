...
The public API lives at the module root (`github.com/go-ruby-resque/resque`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `resque`, while the surface follows
...
```go
import "github.com/go-ruby-resque/resque"
```
...
- **[pkg.go.dev/github.com/go-ruby-resque/resque](https://pkg.go.dev/github.com/go-ruby-resque/resque)**

The module's [README](https://github.com/go-ruby-resque/resque#readme) carries worked
