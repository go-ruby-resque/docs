# go-ruby-resque documentation

**Pure-Go, MRI-4.0.5-faithful Ruby resque (no cgo)**

`go-ruby-resque/resque` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `resque`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `resque`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-resque/resque
```
...
| Repo | What it is |
| --- | --- |
| [`resque`](https://github.com/go-ruby-resque/resque) | the library — Ruby's `resque` in pure Go |
| [`docs`](https://github.com/go-ruby-resque/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-resque.github.io`](https://github.com/go-ruby-resque/go-ruby-resque.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-resque/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-resque/resque](https://github.com/go-ruby-resque/resque).
